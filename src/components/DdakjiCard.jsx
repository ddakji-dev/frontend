    ...
    <div className={`ddakji-wrap hl-${highlight}`} style={{ width: size, height: size, position: 'relative', filter: damaged ? 'grayscale(0.4) brightness(0.95)' : 'none' }}>
      ...
      {showStats && (
        <div className="ddakji-stat-badge" style={{
          ...
          background: 'var(--ink-0)', color: 'var(--paper-0)', padding: '3px 10px',
          borderRadius: 999, fontSize: 11, fontFamily: "'IBM Plex Mono', monospace",
          fontWeight: 600, letterSpacing: '0.04em', whiteSpace: 'nowrap', zIndex: 5,
        }}>
      ...
      {label && (
        <div style={{
          ...
          fontFamily: "'Gowun Batang', serif", fontSize: 13, color: 'var(--ink-2)', letterSpacing: '0.1em',
        }}>
          {label}
        </div>
      )}
...
window.DdakjiCard  = DdakjiCard;
window.DdakjiThumb = DdakjiThumb;
